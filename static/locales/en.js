//  英语
const en = {
	recharge3_modalContent: 'Note: Be sure to transfer according to the prompted amount. If the order is invalid due to failure to transfer according to the prompted amount, the platform will not be responsible! ! !',
	records_form: 'From',
	lang: "English",
	moneyLogo: "U ",
	moneyLogo1: "U",
    ...
    readMore: 'Read more',
    packUp: 'Pack up',
    videoDesc: 'Aviva Group was established on March 12, 2016 as a self-service ordering platform for all international e-commerce companies. Supports mainstream e-commerce platforms such as Shopee, Etsy, Wayfair, Zalando, Amazon, and Ebay. It can effectively improve store ranking and increase store customer flow. Increase sales for online store sellers and enhance the overall reputation of the store. With the current popularity and widespread popularity, many merchants pay more attention to credit, praise, and sales. AVIVA was born under the general trend of market economy. The company has invested a lot of energy and funds in establishing the AVIVA’ APP platform, aiming to provide a strong platform and support for a large number of merchants who are eager to become traffic stores but are limited by their own conditions.',
	earn:'earn',
	// tabbar
    tabbar: {
        home: 'Home',
	...
	home: {
		...
		tip: {
			...
			content: "Tip: Every time you introduce a VIP subordinate, you can get a chance to participate in the lucky draw",
	...
	fund:{
		...
		tip6:'Not yet open',
		rule:'Product rules:',
		Validity_period:" days Validity period",
		initial_imvestment:'Initial mvestment',
	},
    language:{
        title:'Language',
    },
