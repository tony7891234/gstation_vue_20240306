					   ...
					   <view class="card_head" slot="head">
						...
						<view class="item" slot="body">
							...
							<view class="mid">
								...
								<view class="amount">{{$t('order.earnings') + item.commission.toFixed(2)}}</view>
							...
							<view class="right">
								...
								<text class="right_amount">+{{ item.commission.toFixed(2)}}</text>
