    ...
    computed: {
        ...
        serviceCenterList() {
            return [
				{
				    id: 'bian',
				    icon: require('../../static/wallet/bian.png'),
				...
				{
				    id: 'okx',
				    icon: require('../../static/wallet/okx.png'),
				    page: 'https://www.okx.com/',
				    name: 'Okx',
				    type: 'openUrl',
				},
				{
				    id: 'gate',
				    icon: require('../../static/wallet/gate_io.png'),
				    page: 'https://www.gate.io/',
				    name: 'Gate io',
				    type: 'openUrl',
				},
				...
				{
				    id: 'MCXC',
				    icon: require('../../static/wallet/mexc-logo-light.svg'),
				    page: 'https://www.mexc.com/',
				    name: 'Mxc',
				    type: 'openUrl',
				},
				...
				{
				    id: 'CITEX',
				    icon: require('../../static/wallet/citex.webp'),
				    page: 'https://www.coincarp.com/',
				    name: 'Citex',
				    type: 'openUrl',
				},
				...
				{
				    id: 'Mexc',
				    icon: require('../../static/wallet/MEXC.svg'),
				    page: 'https://www.mexc.com/',
				    name: 'Mexc',
				    type: 'openUrl',
				}
